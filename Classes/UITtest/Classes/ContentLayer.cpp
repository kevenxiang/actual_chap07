...
bool ContentLayer::init() {
    ...
    for (int i = 0; i < itemCount; ++i) {
        // 创建Label
        auto label = Label::createWithSystemFont(itemNames[i].itemName, "", 20);
    ...
    auto closeItem = MenuItemImage::create("CloseNormal.png", "CloseSelected.png", CC_CALLBACK_1(ContentLayer::menuCloseCallback, this));
